...
\usepackage[backend=biber,style=$if(biblio-style)$$biblio-style$$else$numeric$endif$,autocite=plain,sorting=none, maxbibnames=99, bibencoding=utf8, defernumbers=true]{biblatex}
...
\printbibliography[title=Data Sources, keyword=data, resetnumbers=true]
