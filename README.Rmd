...
`r badge_cran_release("chronosphere", "orange")` [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3530703.svg)](https://doi.org/10.5281/zenodo.3530703)
...
Open R and paste in: 
```r
install.packages("https://github.com/adamkocsis/chronosphere/raw/master/_archive/source/chronosphere_0.2.1-60.tar.gz", repos=NULL, type="source")
```
...
# Cite as
Kocsis, Ádám T. & Raja, Nussaïbah B. (2020). chronosphere: Earth system history variables (pre-release) (Version 0.2.1). Zenodo. http://doi.org/10.5281/zenodo.3525482
