...
#' land surface areas,  v1.2) resampled to 2x2 degrees resolution. CHELSA (http://chelsa-climate.org/) is a high resolution (30 arc sec, ~1 km) climate data set for the earth land surface areas. 
